...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="voice-mcp", description="Voice MCP Server - Management CLI"
    )
    ...
    test_parser.add_argument("--tts", action="store_true", help="Test text-to-speech")
    test_parser.add_argument("--stt", action="store_true", help="Test speech-to-text")
