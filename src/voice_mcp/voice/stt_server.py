    ...
    def cleanup(self):
        ...
        if self.recorder:
            try:
                ...
                logger.warning("Error during model cleanup", model=self.model_name, error=str(e))
            finally:
                self.recorder = None
...
class STTServerManager:
    ...
    def start(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to start STT server: {str(e)}"
            }
    ...
    def stop(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("STT server stopped", models_unloaded=models_unloaded, uptime=uptime)
            ...
            return {
                "success": False,
                "error": f"Error stopping STT server: {str(e)}"
            }
    ...
    def get_model_recorder(self, model_name: str) -> Optional[Any]:
        """
        ...
        if not result["success"]:
            logger.error("Failed to load model on-demand", model=model_name, error=result.get("error"))
            return None
    ...
    def warm_model(self, model_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Model warmup failed: {str(e)}"
            }
    ...
    def _load_model_impl(self, model_name: str, loading_event: threading.Event) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error("Failed to load model", model=model_name, error=str(e), exc_info=True)
            return {
                "success": False,
...
_stt_server_manager: Optional[STTServerManager] = None


def get_stt_server() -> Optional[STTServerManager]:
