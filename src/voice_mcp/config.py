...
class ServerConfig:
    ...
    def from_env(cls) -> "ServerConfig":
        ...
        return cls(
            ...
            stt_silence_threshold=float(os.getenv("VOICE_MCP_STT_SILENCE_THRESHOLD", "4.0")),
            stt_server_mode=os.getenv("VOICE_MCP_STT_SERVER_MODE", "false").lower() == "true",
            stt_preload_models=cls._parse_model_list(os.getenv("VOICE_MCP_STT_PRELOAD_MODELS", "base")),
            ...
            enable_hotkey=os.getenv("VOICE_MCP_ENABLE_HOTKEY", "true").lower() == "true",
            hotkey_name=os.getenv("VOICE_MCP_HOTKEY_NAME", "menu"),
            hotkey_output_mode=os.getenv("VOICE_MCP_HOTKEY_OUTPUT_MODE", "typing"),
            
            typing_enabled=os.getenv("VOICE_MCP_TYPING_ENABLED", "true").lower() == "true",
            clipboard_enabled=os.getenv("VOICE_MCP_CLIPBOARD_ENABLED", "true").lower() == "true",
            typing_debounce_delay=float(os.getenv("VOICE_MCP_TYPING_DEBOUNCE_DELAY", "0.1")),
