...
from voice_mcp.voice.tts import (
    TTSEngine, 
    Pyttsx3Engine, 
    GTTSEngine, 
    TTSManager, 
...
class TestGTTSEngine:
    ...
    @pytest.mark.skip(reason="gTTS requires pygame which is not installed in test environment")
...
class TestTTSManager:
    ...
    def test_manager_initialization(self):
        ...
        with patch('voice_mcp.voice.tts.Pyttsx3Engine') as mock_pyttsx3, \
    ...
    def test_speak_success(self, mock_tts_engine):
        ...
        with patch('voice_mcp.voice.tts.Pyttsx3Engine') as mock_pyttsx3, \
            ...
            mock_engine_instance.speak.assert_called_once_with("Hello, world!", None, None, None)
